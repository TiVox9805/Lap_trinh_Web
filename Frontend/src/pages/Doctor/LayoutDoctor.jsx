    ...
    return (
        <div className="min-h-screen bg-[#f8fafc] p-4 md:p-8 font-san">
            ...
            {!isSettingsPage && (
                ...
                >
                    <div className="absolute inset-0 bg-gradient-to-r from-indigo-500/20 to-purple-500/20 rounded-[2rem] opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>


                    <div className="relative p-2 bg-gradient-to-br from-indigo-500 to-blue-600 rounded-xl text-white shadow-lg shadow-indigo-500/50 group-hover:rotate-90 transition-transform duration-500 ease-out">
                        <CiCirclePlus size={24} className="stroke-[0.5]" />
                    </div>
                    <div className="relative flex flex-col items-start">
                        <span className="text-[10px] text-indigo-400 uppercase font-black tracking-[0.2em] leading-none mb-1">
                            Tạo hồ sơ
                        </span>
